...
def download_street_network_and_select_random_nodes(city_name):
  ...
  try:
    ...
    def nodes_far_enough(node_list, new_node, min_distance_km=3):
...
def fix_unknown(origin_locations):
  ...
  origin_locations.to_csv('./parameter_data/boeing_locations_3node_sample_B.csv', index=False)/home/arvidh/Documents/GitHub/proj_full-analysis
